...
if __name__ == "__main__":
    ...
    if args.datatype == 'string' and not args.bytes_to_read:
        raise argparse.ArgumentError(
            'Please provide number of bytes to read when using string.')
    ...
    if args.datatype == 'int':
        ...
        response = snap7.util.get_bool(bytes_response, 0, 0)
